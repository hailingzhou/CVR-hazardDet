...
class GQA(Dataset):
    def __init__(self, **args):
        ...
        with open('/mntnfs/med_data2/ziyitang/VQA/Meta-Module-Network/gqa_questions//{}_inputs.json'.format(self.split), 'r') as f:
            self.data = json.load(f)
        print("loading data from {}".format(
            '/mntnfs/med_data2/ziyitang/VQA/Meta-Module-Network/gqa_questions//{}_inputs.json'.format(self.split)))

        if self.split == 'trainval_all_fully':
            with open('/mntnfs/med_data2/ziyitang/VQA/Meta-Module-Network/gqa_questions//trainval_calibrated_fully_inputs.json') as f:
                self.data += json.load(f)
            print("loading additional data from /mntnfs/med_data2/ziyitang/VQA/Meta-Module-Network/gqa_questions//trainval_calibrated_fully_inputs.json")
